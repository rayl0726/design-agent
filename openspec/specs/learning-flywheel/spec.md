...
Define the learning flywheel mechanism that captures user feedback, expands alias lexicon, maintains few-shot examples, and tracks prompt template performance.
